...
(
plant_id varchar2(20) not null,plant_name varchar(30)not null,plant_price number,plant_description varchar(600),plant_price number(10,2),
...
create table orders
(
order_id varchar2(20),customer_id varchar2(20),order_status varchar(20),salesman_id varchar2(20),order_date date,constraint pk_orid primary key(order_id),
constraint fk_custid foreign key(customer_id)references customers (customer_id)
);

create table order_items
(
order_id varchar2(20),item_id varchar2(20) primary key,category_id varchar2(20),plant_id varchar2(20),quantity number,unit_price number,
constraint fk_orid foreign key(order_id) references orders(order_id), constraint fk_plid foreign key(plant_id)references plant_details(plant_id),
...
create table login
(
user_name varchar2(20) not null,password varchar2(20) not null
);

create table register
(
reg_name varchar2(20) not null,reg_mail varchar2(20),reg_password varchar2(20),constraint pk_rm primary key(reg_mail)
);
select *from register;

create table customer_register(name varchar2(30)not null,email_id varchar2(30),password varchar2(20),constraint pk_cusmail primary key(email_id));
